...
class _AddCategoryState extends State<AddCategory> {
  final _Edes = TextEditingController();
  Color mycolor = Colors.lightBlue;
  final _formKey = GlobalKey<FormState>();
  Color pickerColor = Colors.black26;
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () async{
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  cate.cColor=pickerColor.value.toString();
                                  cate.cTitle=_Edes.text;
                                  bool insert=await context.read<CategoryLogic>().insertCate(cate);
                                  if(insert){
                                      Navigator.of(context).pop();
                                  }
                                }
