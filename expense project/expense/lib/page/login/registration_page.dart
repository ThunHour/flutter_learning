...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  final _confirmpassoerd = TextEditingController();
  @override
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                if (_confirmpassoerd.text.trim() ==
                                    _password.text.trim()) {
                                  bool verify = await context
                                      .read<SigninLogic>()
                                      .VerifyUser(_email.text);
                                  Signin user = Signin(
                                      uGmail: _email.text,
                                      uUsername: _username.text,
                                  ...
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return ThemeHelper().alartDialog(
                                          "Password Error",
                                          "Check your password with your confirm password agian!!",
                                          context);
                                    },
                                  );
                                }
